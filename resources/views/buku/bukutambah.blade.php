    ...
    <div class="container p-5" style="max-width: 600px;">
        ...
        <form action="/buku/store" method="POST">
            ...
            <div class="mb-3">
                ...
                <input type="number" class="form-control" id="stok_buku" name="stok_buku" placeholder="Masukkan stok buku" required>
            </div>
            ...
            <div class="mb-3">
                ...
                <select class="form-select" id="id_penulis" name="id_penulis" required>
                    ...
                    @foreach ($penulis as $item)
                        <option value="{{ $item->id_penulis }}">{{ $item->nama_penulis }}</option>
                    @endforeach
                </select>
            </div>
